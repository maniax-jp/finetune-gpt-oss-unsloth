#!/usr/bin/env python3
"""
第4次モデル（データセット拡充後）の出力収集スクリプト

目的: 第4次ファインチューニング後のモデルの応答を収集し、
     第3次モデルとの比較評価を行うためのデータを生成

改善点:
  - データセット: 301 → 455サンプル (1.51倍)
  - 新規データ: +154サンプル（agent-takaichi収集）
  - 期待効果: 基本的事実の正確性向上
"""
...
# モデルパス（第4次ファインチューニング済みモデル）
MODEL_DIR = "outputs/gpt-oss-20b-takaichi-v4-20251021_211622/final"
...
OUTPUT_FILE = f"data/comparison/model_outputs_v4_{timestamp}.json"
...
def load_model():
    """モデルとトークナイザーの読み込み"""
    print("=" * 80)
    print("第4次モデル（データセット拡充後）出力収集")
    print("=" * 80)
    print(f"\nモデルディレクトリ: {MODEL_DIR}")
    print("\n【第4次モデルの改善点】")
    print("  - データセット: 301 → 455サンプル (1.51倍)")
    print("  - 新規データ: +154サンプル（agent-takaichi収集）")
    print("  - 最終Loss: 1.3954")
    print("  - エポック数: 25")
    print()
    print("モデル読み込み中...")
